...
void GameWindow::InitVideo()
{
    ...
    if(_frameBuffer[0] == NULL ) {
        _frameBuffer[0] = MEM_K0_TO_K1(SYS_AllocateFramebuffer(&TVPal576IntDfScale));
    }
    if(_frameBuffer[1] == NULL ) {
        _frameBuffer[1] = MEM_K0_TO_K1(SYS_AllocateFramebuffer(&TVPal576IntDfScale));
    }
    TVPal576IntDfScale.xfbHeight -= 16;
