...
{
    wii_log("guidlgdirselect", "run starting");
        ...
        for(;;) {
            if( GuiDialog::Run() ) {
                ...
                if( dir_level == 0 ) {
                    ...
                    GuiEffectFade gEF1(DIRSEL_FADE_FRAMES,0,true);
                    GuiEffectFade gEF2(DIRSEL_FADE_FRAMES,0,true);
    ...
    wii_log_str("guidlgdirselect", "game_dir var", return_value);
    wii_log("guidlgdirselect", "run ending");
    return return_value;
}
