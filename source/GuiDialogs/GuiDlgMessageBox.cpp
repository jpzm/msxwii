...
{
    wii_log("guidlgmessagebox", "ShowPopup 1 starting");
    va_list marker;
    va_start(marker, txt);
    ...
    va_end(marker);
    wii_log("guidlgmessagebox", "ShowPopup 1 ending");
}

void GuiDlgMessageBox::ShowPopup(GuiContainer *parent, const char *name, const char *image, float alpha, int delay, GuiEffect &effa, GuiEffect &effb, const char *txt, ...)
{
    wii_log("guidlgmessagebox", "ShowPopup 2 starting");
    va_list marker;
    va_start(marker, txt);
    ...
    va_end(marker);
    wii_log("guidlgmessagebox", "ShowPopup 2 ending");
}
...
{
    wii_log("guidlgmessagebox", "constructor starting");
    ...
    wii_log("guidlgmessagebox", "constructor ending");
}
