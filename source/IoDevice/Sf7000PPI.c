...
static UInt8 _read(Sf7000PPI* ppi, UInt16 port)
{
    return i8255Read(ppi->i8255, port);
}

static void _write(Sf7000PPI* ppi, UInt16 port, UInt8 value)
{
...
void sf7000PPICreate()
{
    ...
    ioPortRegister(0xe4, _read, _write, ppi); // PPI Port A
    ioPortRegister(0xe5, _read, _write, ppi); // PPI Port B
    ioPortRegister(0xe6, _read, _write, ppi); // PPI Port C
    ioPortRegister(0xe7, _read, _write, ppi); // PPI Mode
