...
static UInt8 _read(RomMapperNoWind* rm, UInt16 address)
{
...
static void _write(RomMapperNoWind* rm, UInt16 address, UInt8 value)
{
    if (address < 0x4000) {
                         ...
                         int size, int slot, int sslot, int startPage)
{
    ...
    slotRegister(slot, sslot, startPage, 6, (SlotRead)_read, (SlotRead)peek, (SlotWrite)_write, destroy, rm);
