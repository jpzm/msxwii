...
static UInt8 _read(SramMapperS1985* rm, UInt16 ioPort)
{
	UInt8 result;
	switch (ioPort & 0x0f) {
	case 0:
...
static void _write(SramMapperS1985* rm, UInt16 ioPort, UInt8 value)
{
	switch (ioPort & 0x0f) {
	case 1:
...
int sramMapperS1985Create() 
{
    ...
    ioPortRegisterSub(0xfe, _read, _write, rm);
