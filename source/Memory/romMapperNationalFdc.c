...
static UInt8 _read(RomMapperNationalFdc* rm, UInt16 address) 
{
...
static void _write(RomMapperNationalFdc* rm, UInt16 address, UInt8 value) 
{
	switch (address & 0x3fc7) {
	case 0x3f80:
                               ...
                               int size, int slot, int sslot, int startPage) 
{
    ...
    slotRegister(slot, sslot, startPage, pages, _read, peek, _write, destroy, rm);
