...
static UInt8 _read(RomMapperNational* rm, UInt16 address) 
{
...
static void _write(RomMapperNational* rm, UInt16 address, UInt8 value) 
{
	if (address == 0x6000) {
                               ...
                               int size, int slot, int sslot, int startPage) 
{
    ...
    slotRegister(slot, sslot, 0, 8, _read, peek, _write, destroy, rm);
