...
static UInt8 _read(RomMapperTurboRTimer* rm, UInt16 ioPort)
{
...
static void _write(RomMapperTurboRTimer* rm, UInt16 ioPort, UInt8 value)
{
    theTimer->counter = 0;
...
int romMapperTurboRTimerCreate() 
{
    ...
    ioPortRegister(0xe6, _read, _write, rm);
    ioPortRegister(0xe7, _read, _write, rm);
