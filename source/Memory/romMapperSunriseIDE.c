...
static UInt8 _read(RomMapperSunriseIde* rm, UInt16 address) 
{
...
static void _write(RomMapperSunriseIde* rm, UInt16 address, UInt8 value) 
{
                              ...
                              int size, int slot, int sslot, int startPage) 
{
    ...
    slotRegister(slot, sslot, startPage, 8, _read, peek, _write, destroy, rm);
