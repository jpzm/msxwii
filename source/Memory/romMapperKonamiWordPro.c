...
static UInt8 _read(RomMapperKonamiWordPro* rm, UInt16 address)
{
#if 0
...
static void _write(RomMapperKonamiWordPro* rm, UInt16 address, UInt8 value) 
{
#if 0
    printf("W %.4x : 0x%.2x\n", address, value);
#endif
                          ...
                          int size, int slot, int sslot, int startPage) 
{
    ...
    slotRegister(slot, sslot, startPage, pages, _read, _read, _write, destroy, rm);
