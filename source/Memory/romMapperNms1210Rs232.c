...
******************************************
*/
static UInt8 _read(NMS1210Rs232* nms1210Rs232, UInt16 address) 
{
    return 0xff;
}
...
static void _write(NMS1210Rs232* nms1210Rs232, UInt16 address, UInt8 value)
{
}
...
int romMapperNms1210Rs232Create(int slot, int sslot, int startPage)
{
    ...
    slotRegister(slot, sslot, startPage, pages, _read, peek, _write, destroy, nms1210Rs232);
