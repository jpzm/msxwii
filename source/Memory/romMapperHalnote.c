...
static UInt8 _read(RomMapperHalnote* rm, UInt16 address)
{
    int bank;
...
static void _write(RomMapperHalnote* rm, UInt16 address, UInt8 value)
{
    int bank;
    int readMode;
    int mapperMode;
                          ...
                          int size, int slot, int sslot, int startPage) 
{
    ...
    slotRegister(slot, sslot, startPage, 6, _read, _read, _write, destroy, rm);
